...
# print('Shape:', covid19_dataset.shape)
# print('Date min:', np.min(covid19_dataset['Date']),
#       'Date max:', np.max(covid19_dataset['Date']))

covid19_dataset['Country'] = covid19_dataset['Country'].fillna('No_Country')
# print('Replaced No_province Sample: \n', covid19_dataset.tail())

# count_nan = len(covid19_dataset) - covid19_dataset.count()
# print('Nan count: \n', count_nan)
# Total Countries
...
# zones =list((set(covid19_dataset['Province/State'])))
...
for entry in sorted_dates:
    ...
    processed_image_name = 'server/renderer/images/img_' + \
...
imageio.mimsave('server/renderer/covid_animation.gif', images_list)
